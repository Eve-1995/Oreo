...
import { toDoubleInteger, toSeconds } from '../../../../@core/utils/common';
import { Subject } from 'rxjs';
import { takeUntil } from 'rxjs/operators';

@Component({
  selector: 'app-guess-song-my-favorite-songs',
  templateUrl: './guess-song-my-favorite-songs.component.html',
  styleUrls: ['guess-song-my-favorite-songs.component.scss'],
